...
export default function Services() {
  const services = [
    ...
    },
    {
      ...
      description:
        "עבודה שוטפת עם תוכנות ניהול ייעודיות, כולל הקמה, תחזוקה ואופטימיזציה. אני עובדת עם מגוון מערכות CRM ותוכנות ניהול מרפאות ועסקים.",
    ...
    >
      <div className="container mx-auto max-w-6xl">
        ...
        <h1 className="text-3xl md:text-4xl font-bold text-center mb-4">
          שירותי משרד ומזכירות במיקור חוץ — מה כולל השירות?
        </h1>
        <p className="text-gray-600 text-lg text-center mb-12 max-w-3xl mx-auto leading-relaxed">
          שירותי משרד מרחוק ומזכירה וירטואלית במיקור חוץ, בנויים בצורה
          מודולרית - אתם בוחרים בדיוק את מה שאתם צריכים. כל חבילה מותאמת אישית
          לצרכים של העסק שלכם, בלי שירותים מיותרים ובלי עלויות נסתרות.
        </p>
