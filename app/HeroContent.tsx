...
const HeroContent = () => (
  <div
    className="bg-gradient-to-b from-transparent via-black/80 to-transparent p-4 rounded-xlm-0 md:m-5" >
    <h1 className="text-brand-lightTeal text-[clamp(1.4rem,5vw,6rem)] md:text-[clamp(2rem,6vh,6rem)] font-bold mb-4 ">
      שירותי מזכירות רפואית וניהול משרד מרחוק
    </h1>
    <p className="text-base md:text-xl leading-snug md:leading-loose space-y-4 text-brand-lightGray">
      ...
      <span className="block font-bold">
        אתם לא לבד. <br />
        אני אסתי גלר – עם ניסיון של מעל עשור בליווי קליניקות ורופאים – עוזרת לך
        לנהל את הצד התפעולי של הקליניקה ביעילות, בשקט, ובאמינות מלאה.
      </span>
      <span className="block">
