...
export const metadata: Metadata = {
  title: "מזכירה וירטואלית לרופאים ומטפלים | ניהול משרד מרחוק | Esti Office",
  description:
    "שירות מזכירה וירטואלית לרופאים, פסיכולוגים, מטפלים וקוסמטיקאיות – ניהול יומן, גבייה, תיאום תורים ואדמיניסטרציה מרחוק. ללא עלויות מעביד, ללא התחייבות.",

  keywords: [
    "מזכירה וירטואלית",
    "ניהול משרד מרחוק",
    "מזכירה לעסק",
    "שירותי מזכירות לרופאים",
    "ניהול משרד לפסיכולוג",
    "מזכירה מרחוק",
    "מיקור חוץ מזכירות",
    "שירותי back office",
    "ניהול מרפאה פרטית",
  ...
  verification: {
    google: ["U_mO3ozacc4NsxVJbZCtPusNrmWRRH2puwRVXrXMyWA", "a2cd8d28b410ee64"],
  },
};
