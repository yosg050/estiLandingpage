...
export const metadata: Metadata = {
  title: "איך זה עובד? | אסתי גלר - ניהול משרד מרחוק",
  description:
    "תהליך פשוט ומהיר: שיחת היכרות, התאמת תהליכי עבודה והתחלת עבודה מיידית. שאלות נפוצות ותמחור - כל מה שצריך לדעת לפני שמתחילים.",
  alternates: {
